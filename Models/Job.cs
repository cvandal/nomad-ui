...
namespace Nomad.Models
{
    public class Job
    {
        ...
        public int NumOfTaskGroups { get; set; }
        public int QueuedTaskGroups { get; set; }
        public int CompleteTaskGroups { get; set; }
        public int FailedTaskGroups { get; set; }
        public int RunningTaskGroups { get; set; }
        public int StartingTaskGroups { get; set; }
        public int LostTaskGroups { get; set; }
    ...
    public class Task
    {
        ...
        public Dictionary<string, dynamic> Meta { get; set; }
        public object KillTimeout { get; set; }
